...
return [
    ...
    */
    ...
    'max'                  => [
        'numeric' => ':attributeには:max文字以内でご入力ください',
        'file'    => ':attributeには:max KB以下のファイルを指定してください。',
        'string'  => ':max文字以内でご入力ください',
    ...
    'required_if'          => ':attributeは必須項目です。',
    'required_unless'      => ':otherが:values以外の時:attributeは必須項目です。',
    'required_with'        => ':valuesのうちいずれかが指定された時:attributeは必須項目です。',
    'required_with_all'    => ':valuesのうちすべてが指定された時:attributeは必須項目です。',
    'required_without'     => ':valuesのうちいずれかがが指定されなかった時:attributeは必須項目です。',
    'required_without_all' => ':valuesのうちすべてが指定されなかった時:attributeは必須項目です。',
    ...
    */
    ...
    'attributes' => [
        ...
        'first_name' => 'お名前　姓',
        'last_name' => 'お名前　名',
        'furigana_first_name' => 'フリガナ　セイ',
        'furigana_last_name' => 'フリガナ　セイ',
        'gender' => '性別',
        'age' => '年齢',
        'post_code' => '郵便番号',
        'prefecture' => 'ご住所（都道府県）',
        'city' => 'ご住所（市区町村）',
        'additional_address' => 'ご住所（丁目/番地/号/建物名/部屋番号）',
        'telephone' => '電話番号',
        'gift_id' => '景品',
        'qanda' => '????',
    ],
